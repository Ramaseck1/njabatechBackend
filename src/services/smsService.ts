// Service SMS avec gestion d'erreur robuste
let twilioClient: any = null;

// Initialiser Twilio seulement si les variables d'environnement sont configurées
...
export async function sendOrderSms(to: string, message: string) {
  try {
    if (!twilioClient) {
    ...
    // Ne pas faire échouer l'application si l'envoi SMS échoue
