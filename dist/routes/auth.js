...
router.post('/gie/forgot-password', authController_1.AuthController.forgotPasswordGIE);
router.post('/gie/verify-reset-code', authController_1.AuthController.verifyResetCodeGIE);
router.post('/gie/reset-password', authController_1.AuthController.resetPasswordGIE);
